...
/*#ifdef ENABLE_NAGE_SYSTEM
		s_kMap_stType_dwIndex.insert(std::map<std::string, DWORD>::value_type("NAGE", CRaceMotionData::NAME_NAGE));
		s_kMap_stType_dwIndex.insert(std::map<std::string, DWORD>::value_type("NAGE_WAIT", CRaceMotionData::NAME_NAGE_WAIT));
		s_kMap_stType_dwIndex.insert(std::map<std::string, DWORD>::value_type("NAGE_DEAD", CRaceMotionData::NAME_NAGE_DEAD));
#endif
#ifdef ENABLE_MOTION_AFK
		s_kMap_stType_dwIndex.insert(std::map<std::string, DWORD>::value_type("AFK", CRaceMotionData::NAME_AFK));
#endif*/
	}
