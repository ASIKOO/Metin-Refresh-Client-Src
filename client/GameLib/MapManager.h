...
class CMapManager : public CScreen, public IPhysicsWorld
{
	public:
		...
		void			UpdateHD(CMapOutdoor& rkMap);
#endif
		...
		void					SetEnvironmentDataPtr(TEnvironmentData * c_pEnvironmentData);
		void					ResetEnvironmentDataPtr(TEnvironmentData * c_pEnvironmentData);
		void					SetEnvironmentData(int nEnvDataIndex);

		void					BeginEnvironment();
		void					EndEnvironment();

		void					BlendEnvironmentData(TEnvironmentData * c_pEnvironmentData, int iTransitionTime);

		void					GetCurrentEnvironmentData(TEnvironmentData ** c_ppEnvironmentData);
		bool					RegisterEnvironmentData(DWORD dwIndex, const char * c_szFileName);
		bool					GetEnvironmentData(DWORD dwIndex, TEnvironmentData ** c_ppEnvironmentData);
	...
	public:
		...
		TEnvironmentData *	mc_pcurEnvironmentData;
