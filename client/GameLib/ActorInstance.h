...
#define NEW_PET_SYSTEM
		...
		void AttachWeapon(DWORD dwItemIndex, bool bone, DWORD dwParentPartIndex = CRaceData::PART_MAIN, DWORD dwPartIndex = CRaceData::PART_WEAPON);
	...
	public:
		...
		int							compteurTomber;
		float						hauteurVolZ;
		int							m_AileInstanceVol;
#endif
		bool						m_isAFK;
		DWORD						m_vnumAfkWeapon;
		BOOL						m_isMain;
		bool						m_isScaled;
