...
class CGraphicObjectInstance : public CGraphicCollisionObject
{
	...
	public:
		...
		float					ScaleMob;
		void					SetScaleNew(DWORD part, float x, float y, float z);
		void					SetScaleNew(DWORD part, const D3DXVECTOR3 & newscale);
		void					SetScalePosition(DWORD part, float x, float y, float z);
		void					SetScalePosition(DWORD part, const D3DXVECTOR3 & newposition);
	...
	protected:
		...
		D3DXVECTOR3				m_vecScalePos[PART_MAX];
		D3DXVECTOR3				m_vecScaleNew[PART_MAX];
		D3DXMATRIX				m_matAbsoluteTrans[PART_MAX];
		D3DXMATRIX				m_matScale[PART_MAX];
		D3DXMATRIX				m_matPositon[PART_MAX];
