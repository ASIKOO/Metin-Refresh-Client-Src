...
PyObject * itemGetAffect(PyObject * poSelf, PyObject * poArgs)
{
	...
	if ((CItemData::APPLY_ATT_SPEED == ItemApply.bType) && (CItemData::ITEM_TYPE_WEAPON == pItemData->GetType()) && (CItemData::WEAPON_TWO_HANDED == pItemData->GetSubType() || CItemData::COSTUME_WEAPON_TWO_HANDED == pItemData->GetSubType()))
	{
...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "GUILD_SLOT_START_INDEX", CPythonItem::VNUM_MONEY);
	...
	PyModule_AddIntConstant(poModule, "COSTUME_TYPE_WEAPON_CLAW", CItemData::COSTUME_WEAPON_CLAW);
	...
	PyModule_AddIntConstant(poModule, "APPLY_ACCE_ABSORB", CItemData::APPLY_ACCE_ABSORB);
