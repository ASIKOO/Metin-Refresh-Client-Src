...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
	...
	kNetActorData.m_dw7emeSkill = chrAddPacket.dw7emeSkill;
	kNetActorData.m_dw8emeSkill = chrAddPacket.dw8emeSkill;
	kNetActorData.m_dwAIFlag = chrAddPacket.dwAIFlag;
//	kNetActorData.m_dwScale = chrAddPacket.dwScale;
...
bool CPythonNetworkStream::RecvCharacterAdditionalInfo()
{
	...
	if(kNetActorData.m_dwVID == chrInfoPacket.dwVID)
	{
		...
		kNetActorData.m_dw7emeSkill = chrInfoPacket.dw7emeSkill;
		kNetActorData.m_dw8emeSkill = chrInfoPacket.dw8emeSkill;
		kNetActorData.m_dwMountVnum = chrInfoPacket.dwMountVnum;
		//kNetActorData.m_dwScale = string(chrInfoPacket.dwScale);
...
bool CPythonNetworkStream::RecvCharacterUpdatePacket()
{
...
#endif
	kNetUpdateActorData.m_dw7emeSkill = chrUpdatePacket.b7emeSkill;
	kNetUpdateActorData.m_dw8emeSkill = chrUpdatePacket.b8emeSkill;
	...
	//kNetUpdateActorData.m_dwScale = chrUpdatePacket.dwScale;
