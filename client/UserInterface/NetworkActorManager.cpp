...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_dw7emeSkill = src.m_dw7emeSkill;
	m_dw8emeSkill = src.m_dw8emeSkill;
	m_nomTitre = src.m_nomTitre;
	m_couleurtitre1 = src.m_couleurtitre1;
	m_couleurtitre2 = src.m_couleurtitre2;
	m_couleurtitre3 = src.m_couleurtitre3;
...
CInstanceBase* CNetworkActorManager::__AppendCharacterManagerActor(SNetworkActorData& rkNetActorData)
{
	...
	kCreateData.m_dw7emeSkill = rkNetActorData.m_dw7emeSkill;
	kCreateData.m_dw8emeSkill = rkNetActorData.m_dw8emeSkill;
	...
	//kCreateData.m_dwScale = rkNetActorData.m_dwScale;
	...
	if (dwElapsedTime<rkNetActorData.m_dwDuration)
	{
		...
		if (rkNetActorData.m_dwAcce > 0)
		{
			pNewInstance->SetAcce(rkNetActorData.m_dwAcce);
		}
	}
...
void CNetworkActorManager::UpdateActor(const SNetworkUpdateActorData& c_rkNetUpdateActorData)
{
	...
	if (pkInstFind)
	{
		...
		if (c_rkNetUpdateActorData.m_dwAcce > 0)
		{
			pkInstFind->SetAcce(c_rkNetUpdateActorData.m_dwAcce);
		}
		else if (c_rkNetUpdateActorData.m_dwAcce == 0 && rkNetActorData.m_dwAcce > 0)
		{
			pkInstFind->SetAcce(rkNetActorData.m_dwAcce);
		}
		if (c_rkNetUpdateActorData.m_nomTitre.c_str() != "")
		{
			pkInstFind->SetTitre(c_rkNetUpdateActorData.m_dwTitle, c_rkNetUpdateActorData.m_nomTitre.c_str(), c_rkNetUpdateActorData.m_couleurtitre1.c_str(), c_rkNetUpdateActorData.m_couleurtitre2.c_str(), c_rkNetUpdateActorData.m_couleurtitre3.c_str());
			rkNetActorData.m_dwTitle = c_rkNetUpdateActorData.m_dwTitle;
			rkNetActorData.m_nomTitre = c_rkNetUpdateActorData.m_nomTitre.c_str();
			rkNetActorData.m_couleurtitre1 = c_rkNetUpdateActorData.m_couleurtitre1;
			rkNetActorData.m_couleurtitre2 = c_rkNetUpdateActorData.m_couleurtitre2;
			rkNetActorData.m_couleurtitre3 = c_rkNetUpdateActorData.m_couleurtitre3;
		}
		else
		{
			pkInstFind->SetTitre(rkNetActorData.m_dwTitle, rkNetActorData.m_nomTitre.c_str(), rkNetActorData.m_couleurtitre1.c_str(), rkNetActorData.m_couleurtitre2.c_str(), rkNetActorData.m_couleurtitre3.c_str());

		}

		
		
		pkInstFind->Set7emeSkill(c_rkNetUpdateActorData.m_dw7emeSkill);
		pkInstFind->Set8emeSkill(c_rkNetUpdateActorData.m_dw8emeSkill);
