...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_NAGE_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NAGE_SYSTEM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_CLEAR_SASH_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_CLEAR_SASH_SYSTEM", 0);
#endif
