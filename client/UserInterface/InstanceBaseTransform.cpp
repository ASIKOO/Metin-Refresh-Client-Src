...
void CInstanceBase::SetRotationZ(float fRotation)
{
	m_GraphicThingInstance.SetZRotation(fRotation);
}

void CInstanceBase::SetScaleCharacter(D3DXVECTOR3 scale)
{

		m_GraphicThingInstance.SetScaleNew(CRaceData::PART_MAIN, scale);
		m_GraphicThingInstance.SetScaleNew(CRaceData::PART_HAIR, scale);
