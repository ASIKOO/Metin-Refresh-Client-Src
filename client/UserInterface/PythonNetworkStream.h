...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	...
	public:
		...
		void SetLoginInfo(const char* c_szID, const char* c_szPassword, const char* c_szHwid);
		...
		// Private Shop
		bool SendBuildPrivateShopPacket(const char * c_szName, const std::vector<TShopItemTable> & c_rSellingItemStock, int days);
	...
	static string MACAddressHash();
		...
		// Login Phase
		bool SendLoginPacket(const char * c_szName, const char * c_szPassword, const char * c_szHwid);
		bool SendLoginPacketNew(const char * c_szName, const char * c_szPassword, const char * c_szHwid);
		...
		bool SendDirectEnterPacket(const char * c_szName, const char * c_szPassword, const char * c_szHwid, UINT uChrSlot);
