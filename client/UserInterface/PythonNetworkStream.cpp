...
public:
	CMainPacketHeaderMap()
	{
		...
		Set(HEADER_GC_MESSENGER, CNetworkPacketHeaderMap::TPacketType(sizeof(TPacketGCMessenger), STATIC_SIZE_PACKET));
...
void CPythonNetworkStream::SetLoginInfo(const char* c_szID, const char* c_szPassword, const char* c_szHwid)
{
	m_stID = c_szID;
