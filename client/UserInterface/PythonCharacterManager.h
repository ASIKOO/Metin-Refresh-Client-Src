...
class CPythonCharacterManager : public CSingleton<CPythonCharacterManager>, public IAbstractCharacterManager, public IObjectManager
{
	...
	public:
		...
		bool								CheckInstanceVID(DWORD VirtualID);
		...
		void								SecondUpdateScaleMob(CInstanceBase* pInstance);
		void								UpdateScaleMob();
#ifdef ENABLE_VOL_SYSTEM
		bool								UpdateAileVol(int virtualID, TPixelPosition positionPersonnage, bool mouvement, bool statut, float rotationPersonnage);
#endif
	static void								UpdateMouvementPlayer(CInstanceBase* pInstance);
